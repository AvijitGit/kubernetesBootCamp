package com.microservice.ItemCatalog;
...
class ItemInitializer implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
	    ...
	    // This will read data from s3
		//String data = readContecntFromS3();

		Stream.of("Lining", "PUMA", "Bad Boy", "Air Jordan", "Nike", "Adidas", "Reebok", "Avijit")
