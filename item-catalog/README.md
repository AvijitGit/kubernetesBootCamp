...
* The original package name 'com.microservice.Item-Catalog' is invalid and this project uses 'com.microservice.ItemCatalog' instead.
...
* [Building a RESTful Web Service](https://spring.io/guides/gs/rest-service/)s
